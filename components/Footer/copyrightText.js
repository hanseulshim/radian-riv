export default `<span>If you believe a copyright, trademark or other property right has been infringed by any content included or posted on the VOW, including Listing Content, you should immediately send a notification to the VOW Operator’s designated agent (“Designated Agent”), as identified below, and in accordance with the Digital Millennium Copyright Act (“DMCA”), 17 U.S.C. § 512(c). The VOW Operator’s Designated Agent for notice of claims of copyright infringement can be reached as indicated below or by submitting a message herein.
